...
const ServicesSection = dynamic(() => import('@/page-templates/homepage/services-section/services-section'), { ssr: false });
...
const TestimonialsSection = dynamic(() => import('@/page-templates/homepage/testimonials-section'), { ssr: false });
