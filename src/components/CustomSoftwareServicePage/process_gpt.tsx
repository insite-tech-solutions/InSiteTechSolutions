  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-100 dark:border-gray-700 p-6 hover:shadow-lg transition-transform duration-300">
          <div className="flex items-center gap-4 mb-4">
            <div className="p-3 rounded-lg bg-gradient-to-tr from-green-500 to-teal-600">
          ...
          <ul className="space-y-2 mb-4">
            {items.map((item, index) => (
              <li key={index} className="flex items-start gap-2 text-gray-700 dark:text-gray-400">
    ...
    <section className="py-24 bg-gradient-to-b from-gray-100 to-gray-50 dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-6 lg:px-16">
        ...
        >
          ...
          <motion.div
            variants={fadeInUp}
            className="mt-12 bg-gradient-to-r from-purple-50 to-blue-100 dark:from-gray-700 dark:to-gray-800 rounded-2xl p-6 max-w-4xl mx-auto shadow-md border border-gray-200 dark:border-gray-700"
          >
