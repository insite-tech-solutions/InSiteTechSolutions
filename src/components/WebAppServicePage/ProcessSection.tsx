        ...
        >
          <motion.div variants={fadeInUp} className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              We follow a collaborative, transparent, and iterative approach to ensure 
              that every project meets your unique needs while staying on time and on budget. 
              We believe in right-sized solutions - no overengineering, no unnecessary complexity.
            </p>
          </motion.div>
          ...
          >
            <p className="text-gray-700 mb-4">
              We cannot provide exact timelines until we have a well defined project and plan. 
              Projects can range from a few weeks to several months; however, a simple reference 
              point is most small business website projects are completed in 6–8 weeks, while 
              app development can range from 8–16+ weeks, depending on the complexity.
            </p>
            <a 
              href="/process"
