  ...
  items: [
    {
      ...
      answer: "This depends on your business goals. While a logo is a good starting point, a complete brand identity (including color palette, typography, and brand guidelines) provides consistency across all touchpoints and stronger brand recognition."
    },
    {
      icon: "FileText",
      question: "What file formats will I receive for my designs?",
      answer: "We provide all designs in industry-standard formats suited to your needs, typically including vector files (AI, EPS, SVG), print-ready files (PDF), and web-optimized versions (PNG, JPG) for digital use."
    },
    {
      icon: "Copyright",
      question: "Who owns the rights to the designs once the project is complete?",
      answer: "Once the project is fully paid for, you own all rights to the final designs we create for you. We may request permission to showcase the work in our portfolio, but you maintain complete ownership of your brand assets."
    },
    {
      icon: "Clock",
      question: "How long does a typical branding project take?",
      answer: "Timeline varies based on project scope and complexity. A logo typically takes 2-3 weeks, while a complete brand identity system might require 4-8 weeks to develop all elements and guidelines."
    }
  ],
