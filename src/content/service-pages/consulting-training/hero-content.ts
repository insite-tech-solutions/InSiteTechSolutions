/**
 * @fileoverview Hero Content for the Consulting & Training Service Page
 *
 * This file contains the content configuration for the hero section of the Consulting & Training service page.
