/**
 * @fileoverview Service Scope Content for the Consulting & Training Service Page
 *
 * This file contains the content configuration for the service scope section of the Consulting & Training service page.
