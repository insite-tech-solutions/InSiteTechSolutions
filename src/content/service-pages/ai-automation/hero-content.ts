/**
 * @fileoverview Hero Content for the AI & Automation Service Page
 *
 * This file contains the content configuration for the hero section of the AI & Automation service page.
